...
var gunS, attackS, edges;
var startI, start, dying;
...
attackS = loadSound("attack(12).mp3");
startI = loadImage("win.png");
dying = loadSound("dying.mp3");
}
...
healthG = new Group();
//setting collider
human.setCollider("rectangle",20,100,100,200);
human.debug = false;
}
